...
def parse_args():
    ...
    parser.add_argument('--gpus', type=str, nargs='*', default=['0'], help='gpu devices')
...
def main():
    ...
    gpu_options = config.gpu_options.per_process_gpu_memory_fraction = 0.4 # maximun alloc gpu50% of MEM
